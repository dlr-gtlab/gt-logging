...
### Changes
 - The logging library is now installed to the "lib" dir in favor to the old "lib/logging",
   to improve compatibility with a standard unix installation layout. 

### Fixed
 - Fixed some Qt6 related issues when building tests
